    ...
    handle_upate_references_response(parse_data) {
      ...
      if(parse_data!=false) {
        ...
        if(!parse_data.result) {                          //there was a validation problem
          ...
          //.entityTarget.value = parse_data.entity
          //this.directionTarget.value = parse_data.direction
          //this.references_alertTarget.innerHTML = ""//`Much better...`
          this.submit_btnTarget.disabled=false
        } 
        this.relatedfilesframeTarget.reload(); 
      }
    }
    ...
    handle_upate_protocol_response(parse_data) {
      ...
      if(parse_data!=false) {
        ...
        if(!parse_data.result) {                          //there was a validation problem
          ...
          //.entityTarget.value = parse_data.entity
          //this.directionTarget.value = parse_data.direction
          //this.protocol_alertTarget.innerHTML = `status:${parse_data.result} entity:${parse_data.entity} direction:${parse_data.direction}`
          this.submit_btnTarget.disabled=false
        } 
