...
#grid(
  ...
  field(3,"$crsrecords.classnumber$"),
  "",
  ...
  field(1, "$crsrecords.pa$"),
  label(1,"Hizo la Oblación"),
  field(3, "$crsrecords.oblacion$"),
  label(1,"Hizo la Admisión"),
  field(1, "$crsrecords.admision$"),
  label(1,"Hizo la Fidelidad"),
  field(1,  "$crsrecords.fidelidad$"),
)
#pagebreak()
#v(2em)
#grid(
  ...
  field(1,"$crsrecords.letter$"),
  label(2,"Hizo la Admissio"),
  field(1,"$crsrecords.admissio$"),
  label(2,"Recibió el Lectorado"),
  field(1,"$crsrecords.lectorado$"),
  label(2,"Recibió el Acolitado"),
   field(1,"$crsrecords.acolitado$"),
  label(2,"Ordenado Diácono"),
  field(1,"$crsrecords.diaconado$"),
  label(2,"Ordenado Sacerdote"),
  field(1,"$crsrecords.presbiterado$"),
