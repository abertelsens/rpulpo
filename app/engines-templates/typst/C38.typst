...
#grid(
  ...
  field(3, "$crs.oblacion$"),
  label(1,"Hizo la Admisión"),
  field(1, "$crs.admision$"),
  label(1,"Hizo la Fidelidad"),
  field(1,  "$crs.fidelidad$"),
)
#pagebreak()
#v(2em)
#grid(
  ...
  field(1,"$crs.admissio$"),
  label(2,"Recibió el Lectorado"),
  field(1,"$crs.lectorado$"),
  label(2,"Recibió el Acolitado"),
   field(1,"$crs.acolitado$"),
  label(2,"Ordenado Diácono"),
  field(1,"$crs.diaconado$"),
  label(2,"Ordenado Sacerdote"),
  field(1,"$crs.presbiterado$"),
