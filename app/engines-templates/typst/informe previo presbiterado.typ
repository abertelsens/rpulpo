...
header: [#pad(x:-1.5cm, y: 1.5cm, weight: 500, text(size: 15pt, [COLLEGIUM ROMANUM SANCTAE CRUCIS]))]
)
...
El diácono $person.first_name$ $person.family_name$ reúne las cualidades necesarias para recibir la llamada al Presbiterado. No hay nada que añadir a lo señalado en el informe previo al Diaconado: mantiene sus rectas disposiciones de doctrina, piedad y buenas costumbres. Su comportamiento habitual denota equilibrio psíquico y, como se indicaba en el anterior informe, no está afectado por irregularidades u otros impedimentos.
